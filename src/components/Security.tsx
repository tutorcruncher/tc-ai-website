...
const SECURITY_POINTS = [
  {
    title: "UK Data Storage",
    description: "All data stored and processed in the UK",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "DfE AI Standards",
    description: "Meets Department for Education's AI Safety Standards",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description: "We don't train our models on your data",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "Education-Focused AI",
    description: "Augmented AI models dedicated to education",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "Human Support",
    description: "Personal and responsive support team (no AI here!)",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  return (
    <section ref={sectionRef} className="py-20 px-4 bg-page">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <div className="flex items-center gap-3 px-6 py-3 bg-white rounded-full border border-default">
            <svg
            ...
            <span className="font-medium text-primary">Cyber Essentials Certified</span>
          </div>
        </motion.div>
      </div>
    </section>
